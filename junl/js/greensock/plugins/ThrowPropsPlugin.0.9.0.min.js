...
(window._gsQueue || (window._gsQueue = [])).push(function() {
    ...
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(a, b, c, d) {
        ...
        return p.constructor = e, e.version = "0.9.0", e.API = 2, e._autoCSS = !0, e.defaultResistance = 100, e.track = function(a, b, c) {
            ...
            if (this.target = a, this._props = [], s = this, t = b, !j) return window.location.href = "http://" + h + i + "?plugin=" + this._propName, !1;
        ...
        var b, c, d, e, f = /([A-Z])/g,
            g = {}, h = {
                ...
                skewX: 1,
                skewY: 1
            }, i = document.defaultView ? document.defaultView.getComputedStyle : function() {}, j = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
